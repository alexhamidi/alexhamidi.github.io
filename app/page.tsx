  ...
  return (
    <div className="w-full">
      ...
      <section id="start" className="max-w-4xl mx-auto px-8 md:px-16 pt-20">
        ...
        I’m a software engineer studying Computer Science, running SDxUCSD (builder community), and training diffusion models for Data Assimilation at <a href="https://scripps.ucsd.edu/profiles/mmorzfeld" target="_blank" rel="noopener noreferrer" className="text-black no-underline border-b border-neutral-300 hover:border-black transition-colors">Scripps</a>. Previously, I worked on search infrastructure at Clado and automations at Amazon.
        </p>
