---
title: "Umari"
description: "How I built a fast browser agent using a two-model split architecture, aggressive patch caching, and RL-trained grounding to make general desktop automation more usable."
date: "2025-10"
